 ...
 */
class UsuarioLoginStatus extends \Usuario\Entity\UsuarioLoginStatus implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'inputFilter', 'idLoginStatus', 'nome');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (UsuarioLoginStatus $proxy) {
