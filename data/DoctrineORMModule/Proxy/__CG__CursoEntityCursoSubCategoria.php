 ...
 */
class CursoSubCategoria extends \Curso\Entity\CursoSubCategoria implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'inputFilter', 'idCursoSubCategoria', 'cursoCategoria', 'nome', 'descricao', 'dataAtualizacao', 'status');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CursoSubCategoria $proxy) {
