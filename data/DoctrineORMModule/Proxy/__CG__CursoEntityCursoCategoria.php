 ...
 */
class CursoCategoria extends \Curso\Entity\CursoCategoria implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'inputFilter', 'idCursoCategoria', 'nome', 'descricao', 'status', 'dataAtualizacao');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CursoCategoria $proxy) {
