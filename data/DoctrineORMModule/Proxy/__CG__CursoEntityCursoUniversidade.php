 ...
 */
class CursoUniversidade extends \Curso\Entity\CursoUniversidade implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'inputFilter', 'idUniversidade', 'nome', 'descricao', 'sigla', 'dataAtualizacao');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CursoUniversidade $proxy) {
