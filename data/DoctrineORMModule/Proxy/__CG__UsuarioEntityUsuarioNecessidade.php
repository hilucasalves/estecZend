 ...
 */
class UsuarioNecessidade extends \Usuario\Entity\UsuarioNecessidade implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'inputFilter', 'idNecessidadeEspecial', 'nome', 'dataAtualizacao');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (UsuarioNecessidade $proxy) {
