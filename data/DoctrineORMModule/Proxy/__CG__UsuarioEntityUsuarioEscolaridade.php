 ...
 */
class UsuarioEscolaridade extends \Usuario\Entity\UsuarioEscolaridade implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'inputFilter', 'idEscolaridade', 'nome', 'dataAtualizacao');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (UsuarioEscolaridade $proxy) {
