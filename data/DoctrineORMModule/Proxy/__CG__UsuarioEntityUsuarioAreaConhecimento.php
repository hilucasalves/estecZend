 ...
 */
class UsuarioAreaConhecimento extends \Usuario\Entity\UsuarioAreaConhecimento implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'inputFilter', 'idAreaConhecimento', 'nome', 'dataAtualizacao');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (UsuarioAreaConhecimento $proxy) {
